...
# Default user setup
User.create(:name => 'Administrator', :email => 'SMOOTHSEC_EMAIL', :password => 'SMOOTHSEC_PASSWORD', :password_confirmation => 'SMOOTHSEC_PASSWORD', :admin => true) if User.all.blank?
